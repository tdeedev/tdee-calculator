...
<div class="container">
	...
	<a class="clicky_log_outbound" href="http://trk.tdeecalculator.net/tracking202/redirect/dl.php?t202id=5157&c1=<?php echo $age; ?>yrs&c2=<?php echo number_format($bmi); ?>BMI&c3=<?php echo $platform; ?>&t202kw=placement1">
			<img src="images/mybikinibutt.gif" alt="" width="468" style="display:block;margin:-15px auto 20px;">
	</a>
	...
	<h2 class="h3 text-center" style="margin-top:3px;">Calorie Tracking Tools</h2>
			...
			<li><strong>Bread Sucks</strong> - read the nutrition label on a loaf of bread. It is pure carbs with no redeeming qualities. You would have to eat like 20 pieces of bread to get your daily fiber, so that's not gonna work. I love bread and eat it all the time, but not everyday considering it's nutritional value is terrible. If you love sandwiches and you eat out alot, try ordering your burger without the bread and with a lettuce wrap instead (where the lettuce wrap acts like the bun). I actually think I like it better without the bread, try it next time!</li>
			...
			<p>The ONLY reason losing weight can be difficult is because creating new habits is something people avoid and don't like doing. I get it, it's hard. You just have to mentally commit to cleaning up your diet, and you need to make it a habit. Like anything, you just have to <em>start</em>.</p>
			
			<p>You <em>totally can</em> choose foods that you actually enjoy and are nutritious at the same time. The word "diet" has a negative connotation, it sounds like it's gonna be terrible, but it's really not if your meal plan is made up of foods you <u>actually like.</u> All creating a meal plan requires is that you learn a little bit about nutrition and cooking. If you want to learn about good nutrition, check out <a rel="nofollow" href="http://indexphp22.mikegeary1.hop.clickbank.net/?pid=240">Fat Burning Kitchen</a> (excuse the hype on the salespage, it's actually quite good).</p>
